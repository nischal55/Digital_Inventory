...
<div class="menu">
    ...
    <div class="nav-menu">
        <ul>
            <li><a href="../pages/adminDashboard.php"><i class="fa-solid fa-house"></i> Dashboard</a></li>
            <li><a href="../pages/createUser.php"> <i class="fa-solid fa-user"></i> User Management</a></li>
            <li><a href="../pages/category.php"><i class="fa-regular fa-grid-2"></i> Categories</a> </li>
            <li class="products_nav"><a href="../pages/product.php"><i class="fa-solid fa-grid-2" style="color: #ffffff;"></i> Products</a> </li>
